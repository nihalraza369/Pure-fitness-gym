...
const TIMING_TABS = [
  {
    ...
    hours: [
      ...
      { day: "Wednesday", time: "6 AM – 12 AM" },
      { day: "Thursday", time: "6 AM – 12 AM" },
      { day: "Friday", time: "6 AM – 12 AM" },
      { day: "Saturday", time: "6 AM – 12 AM" },
  ...
  },
  {
    id: "boys",
    label: "Boys",
    tagline: "Men's floor · Open 24h Mon-Tue · 6 AM – 12 AM Wed-Sat",
    desc: "The full gym is open 24 hours on Monday and Tuesday, and 6 AM to 12 AM from Wednesday to Saturday. Sunday closed.",
    hours: [
      { day: "Monday", time: "Open 24 hours" },
      { day: "Tuesday", time: "Open 24 hours" },
      { day: "Wednesday", time: "6 AM – 12 AM" },
